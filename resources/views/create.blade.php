        ...
        <div class="row justify-content-center bg-light mb-3">
            <div class="col-12">                       
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" aria-describedby="categoryHelp" placeholder="Nama Sampah">
                    <button class="btn my-3 p-3 col-12 rounded-3" style="color:aliceblue; background-color: #30AEE4;" onClick="store()">Tambah</button>
                </div>
            </div>
        </div>
    </div>
